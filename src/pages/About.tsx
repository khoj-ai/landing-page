        ...
        <section className="core-page">
            <div className='content-sections'>
                <div className='article'>
                    <h2 className="title">What we're making</h2>
                        <div className="content">
                            ...
                            <p className='content'>
                                For greater assistance, we've added in a chat layer which can interface with large language models. These can effectively act as summarization agents, making it so that you have to parse through even less information to get to your answer.
                            </p>
                            <p className='content'>
                        ...
                        <h2 className='title'>Why we're making it</h2>
                        <div className='content'>
                            <p className='content'>
                        ...
                        <div className='content'>
                            ...
                            <ul className='content'>
                                <li className='content'>
                                    <a className='inline-content-link' href="https://discord.gg/ysRzcUnj">Discord</a>
                                    <p className='content'>This is best if you
                                    re looking to learn more about the product and participate in discussions.</p>
                                </li>
                                <li className='content'>
                                    <a className='inline-content-link' href="https://github.com/debanjum/khoj/issues">Github Issues</a>
                                    <p className='content'>This is best if you have a bug to report or a feature request.</p>
                                </li>
                                <li className='content'>
                                    <a className='inline-content-link' href="mailto:founders@khoj.dev">Email</a>
                ...
                <div className='animation'>
                    <Player
                        ...
                        speed={1}
                        loop
                        src='./127255-cute-astronaut-looking-star-with-telescope.json'
                        style={{ width: '100%' }}
                        />
                </div>
            </div>
